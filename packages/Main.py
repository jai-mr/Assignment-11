...
# from data_summary import model_summary,display,_imshow
...
from CusResNet import *
from Net import *
from S11_Model import *
...
class MainFile():
    def __init__(self,device='cuda', model_name = CusResNet18 , criterion = nn.CrossEntropyLoss(), optimizer = 'SGD'):
        self.device = device
    ...
    def model(self, input_size= (3,32,32)):
    ...
    def fit(self, train_loader, test_loader, val_loader=None, epochs= 10, scheduler={'name':None}, lr=0.01, momentum=0.9, weight_decay= 0, plot_lr= False):
        ...
        gdrivepath="gdrive/My Drive/Colab Notebooks/S11/content/"
        if self.val_loader:
            ...
            self.best_model.load_state_dict(torch.load(gdrivepath + 'savedmodel/classifier.pt'))
